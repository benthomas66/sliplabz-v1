...
3. ~~**Audit + commit** the bounded driver~~ **DONE `54c346d`** — ← **CURRENT: the one-game validation is next** (paid-seam wiring audited to the same bar → ~40cr fetch).
4. Founder authorizes **ONE ~40cr historical request** against a **mapped · regular-season · box-score-complete · non-GAP-35** target.
5. Audit the one-game result: persistence · canonicalization · hlr · boundary · **ownership attribution** (not global count deltas) · gate.
6. Founder rules on the **broader Path C repair**.
